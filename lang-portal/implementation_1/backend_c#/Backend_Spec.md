...
- The API will be built using WebAPI
- Use entity framework code first approach for database managements
...
Our database will be a single sqlite database called `words.db` that will be in the root of the project folder of `backend_c#`
